...
let { $EntityAttributeModificationEvent } = require("packages/net/minecraftforge/event/entity/$EntityAttributeModificationEvent")
...
myRequire.$EntityAttributeModificationEvent = $EntityAttributeModificationEvent